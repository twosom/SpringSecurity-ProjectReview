...
public class UserManagerController {
    ...
    public String allAccounts(Model model) {
        List<Account> accountList = userService.getAllAccounts();
    ...
    public String accountDetail(@PathVariable("id") Long id, Model model) {
        AccountDto accountDto = userService.getAccountDtoById(id);
        model.addAttribute("account", accountDto);
        model.addAttribute("roleList", roleService.getRolesOrderByGrade());
