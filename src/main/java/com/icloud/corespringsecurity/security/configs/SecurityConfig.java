...
import com.icloud.corespringsecurity.security.factory.UrlFilterInvocationFactoryBean;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final UrlFilterInvocationFactoryBean urlFilterInvocationFactoryBean;
...
//                .antMatchers("/config").hasRole("ADMIN")
    ...
    public Filter permitAllFilter() throws Exception {
        PermitAllFilter permitAllFilter = new PermitAllFilter("/", "/users", "user/login/**", "/api/login");
        permitAllFilter.setAuthenticationManager(authenticationManager());
        permitAllFilter.setSecurityMetadataSource(urlFilterInvocationSecurityMetadataSource());
//        permitAllFilter.setAccessDecisionManager(new AffirmativeBased(Arrays.asList(new RoleVoter())));
    ...
    public FilterInvocationSecurityMetadataSource urlFilterInvocationSecurityMetadataSource() throws Exception {
        return new UrlFilterInvocationSecurityMetadataSource(urlFilterInvocationFactoryBean.getObject(), resourcesService);
    }
